...
Login to your dedicated CCP Dashboard - find URL in [Table 1](LAB_access.md), use your Active Directory credentials that you can find in paper sheet on your desk.
