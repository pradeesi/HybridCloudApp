...
class Sensor_DB_Class:
	...
	def __init__(self, db_host, db_port, db_user, db_password, db_name):
		print ("Inside the DB constructor...")
	...
	def initialize_db(self):
		try:
			print ("Trying to initialize the DB Tables....")
			# Connect to DB
			print ("Connect with SQL Server...")
	...
	def open_db_connection(self):
		try:
			print ("DB Class: Trying to open DB Connection...")
			# Open DB connection
			...
			self.cursor = cursor
			print ("DB Class: Connection Open...")
		except mariadb.Error as error:
			print("Error: {}".format(error))
	...
	def insert_into_database(self, json_payload):
		...
		try:
			...
			print "Error while trying to insert data into the database"
		return
