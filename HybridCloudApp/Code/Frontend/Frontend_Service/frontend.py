...
BACKEND_PORT = str(os.environ['BACKEND_PORT'])
...
def iot_dashboard(city_name):
	...
	r = requests.get('http://' + BACKEND_HOST + ':' + BACKEND_PORT + '/sensor_data/' + str(city_name))
	...
	r = requests.get('http://' + BACKEND_HOST + ':' + BACKEND_PORT + '/cities')
	if r.status_code == 200:
